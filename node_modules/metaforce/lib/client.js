...
(function() {
  ...
  module.exports = Client = (function() {
    function Client(opts) {
      ...
      this.apiVersion = opts.apiVersion || 26.0;
      ...
      if (!~this.endpoint.indexOf('/services')) {
        this.endpoint += '/services/Soap/u/26.0';
      }
      this.sid = opts.sid || '';
    ...
    Client.prototype.client = function(type, callback) {
      ...
      wsdl = path.resolve(__dirname, "../wsdl/" + (this.apiVersion.toFixed(1)) + "/" + type + ".xml");
      switch (type) {
        case 'metadata':
          repl = '/m/';
          break;
